...
if(isset($_POST['submit']))        
    {       
          ...
          $result1=mysqli_query($conn,"INSERT INTO admin (firstname,phoneno,lastname,address,password,email,department,dob,gender,companyid,jposition,boss)Values ('$firstname','$phoneno','$lastname','$address','$password','$email','$department','$dob','$gender','$companyid','$jposition','$boss')");   
...
<div class="navbar navbar-default navbar-fixed-left">
    ...
    echo $value;
             $user=mysqli_query($conn,"SELECT * FROM admin WHERE companyid='$value' AND jposition='hr' ");
            ...
            echo "
            <br>
            <img src='ikenna.jpeg' class='img-thumbnail' width='135' height='50'>
            <a class='navbar-brand' href='#'>Welcome HR/School officer </a>";  
                  }
         ?>  
          ...
          <ul class="nav navbar-nav">
              ...
              <li class="sidebar-search">
               ...
               <li><a href="hrinterface.php">Profile</a></li>            
               <li><a href="areg.php">Add Admin</a></li>
               <!-- <li><a href="#">History</a></li> -->
               <li><a href="viewagoals.php">Admin goals</a></li>
					...
					<form id="id-signup-form" method="post" action="">   
                                             <div class="row">
                                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-6">                                                   
                                                    <div class="form-group">
                                                                  ...
                                                                  $email  = $_SESSION['username'];
                                                                    ...
                                                                    $drake=mysqli_query($conn,"SELECT * FROM admin WHERE department='$dept' AND companyid='$email'");
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12 col-lg-6">
															<div class="form-group">
																	...
																	<div class="input-group">
																			<input type="text" class="form-control" placeholder="Job Position" name="jposition" id="id-fullname" aria-describedby="fullname"required>
							             ...
							             <div class="row">
                                            ...
                                            <div class="row">
													<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
															<div class="form-group">
                                                                <label for="id-matric-no">Department</label>
																	<div class="input-group">											
                                                                        <input list="browsers"  class="form-control" name="department" placeholder="Department" d="id-matric-no" aria-describedby="matric_no"required />
											...
											<div class="row">
                                                    ...
                                                    <div class="row">
                                                     ...
                                                     <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6 col-lg-offset-3">
                                                            <div class="form-group">
                                                                        <label for="id-matric-no">Boss</label>
                                                                        <div class="input-group">
                                                                                <input type="text" class="form-control" value="hr" name="boss" id="id-matric-no" aria-describedby="matric_no" readonly="true" required>
                                                                                <span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
                                                                        </div>
                                                            </div>
                                                     </div>
