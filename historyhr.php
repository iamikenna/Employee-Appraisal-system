        ...
        $dept=$_SESSION['dept'];
         ...
         ?>  
          ...
          <ul class="nav navbar-nav">
            ...
            <li><a href="historyhr.php">History</a></li>
        ...
        <div class="col-lg-12 text-center">
                ...
                <div class="sub-container text-center" role="region" aria-labelledby="main-title">
                        ...
                        -->
                            ...
                            <a role="button" id="top-student-signup-button" href="appraisal_hr.php"  class="btn btn-danger btn-md"> View Appraisal&nbsp; <span class="glyphicon glyphicon-pencil"></span></a>
