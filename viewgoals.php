                ...
                <div class="login-panel panel panel-default">                  
                    ...
                    <div class="panel-body">
                            <fieldset>
                                        ...
                                        <table class="table table-bordered table-hover table-striped" width="100%" height="100%">
                                            <thead>
                                               <tr>
                                                    ...
                                                    <th><b>Last-Name</b></th>
                                                    <th>Status   <strong> <b>*Pending* <span class='glyphicon glyphicon-info-sign'></span>      </b></strong></th>                                            
                             ...
                             $dept=$_SESSION['dept'];
                                                    // var_dump($dept);
                                $doi=mysqli_query($conn,"SELECT * FROM staffsetgoal WHERE department='$dept' AND accepted='FALSE'");
                                                     if ($doi->num_rows > 0)
                                     {
                                    ...
                                    echo" <div class=''>
                                            <tr>
                                                <td>
                                                    ".$row['firstname']."</td> <td>".$row['lastname']."</td> <td> 
                                               <a href='goalreview.php?id=".$row['id']."'>      
                                                <button type='submit' name='setgo' id='top-teacher-signup-button' href='#' class='btn btn-default btn-              xs'>View  <span class='glyphicon glyphicon-check'></span>              
                                                </button> 
                                                </a>
                                                  
                                                  <a href='declinegoal.php?id=".$row['id']."'> 
                                                      <button type='submit' name='setgo' id='top-teacher-signup-button' href='#' class='btn btn-danger btn- xs'>Decline  <span class='glyphicon glyphicon-remove'></span>              
                                                </button>        
                                                    </a>
                                                         <br>
                                                </td> 
