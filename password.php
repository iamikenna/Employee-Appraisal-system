...
$password=$_POST['password'];  
 ...
 $drake = mysqli_query($conn, "SELECT * FROM admin  WHERE password='$password '");
if ($drake->num_rows > 0){ 
...
<div class="navbar navbar-default navbar-fixed-left">
        <?php
             ...
             $user=mysqli_query($conn,"SELECT * FROM staffsignup WHERE email='$value' ");
         ...
         ?>  
          ...
          <ul class="nav navbar-nav">
              ...
              <li class="sidebar-search">
               ...
               <li><a href="scontact.php">Settings</a></li>
                  <br>
