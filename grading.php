		 ...
		 <div class="row">
            ...
            <div class="col-md-4 col-lg-9 col-lg-offset-2">
                <div class="login-panel panel panel-default">                  
                                                     ...
                                                     <div class="input-group">
                                                            <?php
                                                                  $dept  = $_SESSION['dept'];
                                                                    ...
                                                                    $drake=mysqli_query($conn,"SELECT * FROM staffsetgoal WHERE companyid='$companyid' AND id='$staff_id' ");
                                  ...
                                  <tr>
                                        ...
                                        <tr>
                                                   ...
                                                   <td>
                                                     ...
                                                     <div class="input-group">
                                        <input type='text' class='form-control' value='' name='hrsign'  aria-describedby='email' readonly="true" >
                                  </div>
                   ...
                   <?php
                             $dept=$_SESSION['dept'];
                                $doi=mysqli_query($conn,"SELECT * FROM staffsetgoal WHERE companyid='$companyid' AND id='$staff_id'");
                                                     if ($doi->num_rows > 0)
                                     {
