...
<div class="navbar navbar-default navbar-fixed-left">
          ...
          // var_dump($email);
             ...
             $user=mysqli_query($conn,"SELECT * FROM admin WHERE firstname='$firstname'");
   ...
   <div class="container">
		...
		<div class="container text-center">
			<h2 class="nino-sectionHeading">
				<span class="nino-subHeading">Pending Appraisal!</span>
				Status: 
            ...
            <div class="col-md-4 col-lg-9 col-lg-offset-2">
                                        ...
                                        <table class="table table-bordered table-hover table-striped" width="100%" height="100%">
                                            <thead>
                                               <tr>
                                                    ...
                                                    <th><b>Date of Review</b></th>
                                                    <th><b>FirstName</b></th>
                                                    <th><b>Last Name</b></th>
                                                    <th><b>Reviewer Staus</b></th>
                                                    <th><b>HR Status</b></th>
                                                    <th><b>Boss</b></th>
                                                    <th><b>Grade<br>(Total score/100)</b></th>
                                                    <th>Report<strong></th> 
                                                    <th>Status<strong></th>                                            
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   $firstname = $_SESSION['firstname'];
                                                $user=mysqli_query($conn,"SELECT * FROM appraisalone WHERE firstname='$firstname'AND rsign='SIGNED' AND hrsign='' ");
                                                $accept=mysqli_query($conn,"SELECT * FROM appraisalone WHERE firstname='$firstname'AND rsign='SIGNED' AND hrsign='SIGNED'");
              ...
              if ($user->num_rows > 0)
                                    ...
                                    echo" <div class=''>
                                            <tr>
                                                <td>
                                                    ".$row['sog']."</td> <td>".$row['eog']."</td><td>".$row['date']."</td><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['rsign']."</td><td>".$row['hrsign']."</td><td>".$row['boss']."</td><td>".$row['grade']."</td><td>".$row['report']."</td> <td> 
              ...
              if ($accept->num_rows > 0)
                                    ...
                                    echo" <div class=''>
                                            <tr>
                                                <td>
                                                     ".$row['sog']."</td> <td>".$row['eog']."</td><td>".$row['date']."</td><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['rsign']."</td><td>".$row['hrsign']."</td><td>".$row['boss']."</td><td>".$row['grade']."</td><td>".$row['comment']."</td> <td> 
                                              
                                                  
                                                 
                                                      <button id='top-teacher-signup-button'  class='btn btn-success  btn- xs'>  Completed       <span class='glyphicon glyphicon-ok'></span>              
                                                </button>        
