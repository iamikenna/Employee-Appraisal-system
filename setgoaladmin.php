...
if(isset($_POST['submitt']))        
    {       
            ...
            $admin_id = $_SESSION['id'];
             ...
             $result1=mysqli_query($conn,"INSERT INTO adminsetgoal (companyid,firstname,lastname,boss,jposition,department,eog,sog,goal1,goal2,goal3,admin_id)Values ('$companyid','$firstname','$lastname','$boss','$jposition','$department','$eog','$sog','$goal1','$goal2','$goal3', '$admin_id')");   
                                            ...
                                            <tbody>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
												        <div class="form-group">
																	...
																	<div class="input-group">
																			<input type="date" class="form-control" placeholder="Start date" name="sog" id="id-matric-no" aria-describedby="matric_no"required>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
												        <div class="form-group">
																	...
																	<div class="input-group">
																			<input type="date" class="form-control" placeholder="End date" name="eog" id="id-matric-no" aria-describedby="matric_no"required>
																			<span class="input-group-addon"><span class="glyphicon glyphicon-envelope"></span>
																	</div>
												        </div>
													</div>
