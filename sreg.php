...
//declared variables to hold stored data
...
$drake=mysqli_query($conn,"SELECT * FROM admin WHERE email='$email' ");
...
if(isset($_POST['submit']))        
    {       
          ...
          $result1=mysqli_query($conn,"INSERT INTO staffsignup (firstname,phoneno,lastname,address,password,email,jposition,dob,gender,companyid,boss,department) Values ('$firstname','$phoneno','$lastname','$address','$password','$email','$jposition','$dob','$gender','$ci','$bos','$dept')");   
...
<div class="navbar navbar-default navbar-fixed-left">
        <?php
             ...
             $user=mysqli_query($conn,"SELECT * FROM admin WHERE email='$value' ");
            ...
            echo "
            <br>
            <img src='# class='img-thumbnail' width='135' height='50'>
         ...
         ?>  
          ...
          <ul class="nav navbar-nav">
              ...
              <li><a href="viewgoals.php">Staff goals</a></li>
              
               <li><a href="setgoaladmin.php">Set goal</a></li>
    ...
    <div class="container">
		<div class="class-hr-label text-center ">
            <h3 id="joini"><strong>Staff Registration !</strong></h3>						
		</div>
					...
					<form id="id-signup-form" method="post" action="">  
							             ...
							             <div class="row">
                                            ...
                                            <div class="row">
													<div class="col-md-6 col-sm-6 col-xs-12 col-lg-6">
															<div class="form-group">
                                                                <label for="id-matric-no">Job position</label>
																	<div class="input-group">											
                                                                        <input list="browsers"  class="form-control" name="jposition" placeholder="Job Position" d="id-matric-no" aria-describedby="matric_no"required />
