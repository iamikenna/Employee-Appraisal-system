...
$password=$_POST['password'];  
 ...
 $companyid= $_SESSION['username'];
  ...
  $drake = mysqli_query($conn, "SELECT * FROM staffsignup WHERE email= '$email' AND companyid='$companyid' AND password='$password'");
if ($drake->num_rows == 1) 
{ 
				...
				<div class="container">
					...
					<div class="navbar-header">
						...
						<a class="navbar-brand" style="size:10px;" href="homepage.html">
                             ...
                             <a class='navbar-brand' href='uihome.php'>  Welcome, Staff</a>
