                                        ...
                                        <table class="table table-bordered table-hover table-striped" width="100%" height="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   $id = $_SESSION['id'];
                                                $user=mysqli_query($conn,"SELECT * FROM appraisalone WHERE staff_id='$id'AND rsign='SIGNED' AND hrsign='' ");
                                                $accept=mysqli_query($conn,"SELECT * FROM appraisalone WHERE staff_id='$id'AND rsign='SIGNED' AND hrsign='SIGNED'");
