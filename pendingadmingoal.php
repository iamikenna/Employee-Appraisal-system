		...
		<div class="container text-center">
		 ...
		 <div class="row">
            ...
            <div class="col-md-4 col-lg-9 col-lg-offset-2">
             ...
             $user=mysqli_query($conn,"SELECT * FROM adminsetgoal WHERE admin_id='$id' AND accepted = 'FALSE'");
             $accept=mysqli_query($conn,"SELECT * FROM adminsetgoal WHERE admin_id='$id' AND accepted = 'TRUE'");
