...
<!--               <li><a href="pendingapp.php">View appraisal</a></li>-->
    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <div class="sub-container text-center" role="region" aria-labelledby="main-title">
                        ...
                        -->
                            <a role="button" id="top-student-signup-button" href="pendingapp.php"  class="btn btn-info btn-md">View Goals&nbsp; <span class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;
                            <a role="button" id="top-student-signup-button" href="pendingapp2.php"  class="btn btn-danger btn-md"> View Appraisal&nbsp; <span class="glyphicon glyphicon-pencil"></span></a>
