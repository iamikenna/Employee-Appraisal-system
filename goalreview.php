...
<html lang="en-us">
	<head>
		<title>  Goals Review | Portal </title>
    ...
    <div class="container">
		...
		<div class="container text-center">
			<h2 class="nino-sectionHeading">
				<span class="nino-subHeading"> Goal details!</span>
				Review: 
                        ...
                        <form method="GET" action="">
                            <fieldset>
                             ...
                             $dept=$_SESSION['dept'];
                                ...
                                $doi=mysqli_query($conn,"SELECT * FROM staffsetgoal WHERE department='$dept' AND id='$id'");
                                                     if ($doi->num_rows ==1)
                                     {
                                    ...
                                    echo" <div class=''>
                                            <tr>
                                               <div class='hidden-lg'> <td>".$row['lastname']."</td> <td> </div>
                                                  ...
                                                  <a href='acceptgoal.php?id=".$row['id']."'> 
                                                      <button type='submit' name='setgo' id='top-teacher-signup-button' href='#' class='btn btn-success btn- xs'>Accept  <span class='glyphicon glyphicon-ok'></span>              
                                                </button>        
                                                    </a>
                                                         <br>
                                                </td> 
