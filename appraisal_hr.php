                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped" width="100%" height="100%">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                             $dept=$_SESSION['dept'];
                                $doi=mysqli_query($conn,"SELECT * FROM adminsetgoal WHERE companyid='$companyid' AND accepted='TRUE' AND appraisal='FALSE'");
                                                     if ($doi->num_rows > 0)
                                     {
                                    ...
                                    echo" <div class=''>
                                            <tr>
                                                <td>
                                                    ".$row['firstname']."</td> <td>".$row['lastname']."</td><td>".$row['sog']."</td><td>".$row['eog']."</td> <td> 
                                               <a href='gradinga.php?id=".$row['id']."'>      
                                                <button type='submit' name='setgo' id='top-teacher-signup-button' href='#' class='btn btn-default btn-              xs'>Appraise <span class='glyphicon glyphicon-check'></span>              
                                                </button> 
                                                </a>
